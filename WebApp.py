...
original_data = pd.read_csv("C:/Users/91809/Downloads/marketing_campaign.csv",sep="/t")
no_clusters_PCA = pd.read_csv("C:/Users/91809\Downloads/no_clusters_pca.csv")
clustered_PCA = pd.read_csv("C:/Users/91809\Downloads/clustered_pca.csv")
clustered_data = pd.read_csv("C:/Users/91809\Downloads/clustered_data.csv")
...
def main():
    ...
    st.caption("Full notebook with analysis and model creation is [here]"
               "(https://github.com/skand08/Customer-Personality-Analysis/blob/main/Customer_Segmentation.ipynb)")
    ...
    cluster_counts = clustered_data['Clusters'].value_counts() 
    fig3 = px.pie(clustered_data, values=cluster_counts.values, names=cluster_counts.index,  title="Distribution of Clusters")
    ...
    st.caption("[You can check out full work and summary here.](https://github.com/skand08/Customer-Personality-Analysis)")
